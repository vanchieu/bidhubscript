print("Chào mừng đến với script BID HUB")
$lua Chào mừng đến với script BID HUB
local Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("<Color=Cyan>Welcome to BID HUB<Color=/>"):Display()
wait(0.5)
Notification.new("<Color=Yellow>Everyone Goes to Discord to Communicate<Color=/>"):Display()
wait(1)
repeat
    wait()
until game.Players.LocalPlayerprint("https://discord.gg/aUd8umqUKu")
...
local function toTarget(...)
	...
	if _G.Settings.Configs["Bypass TP"] then
		if Distance > 3000 and not AutoFarmMaterial and not _G.Settings.FightingStyle["Auto God Human"] and not _G.Setti